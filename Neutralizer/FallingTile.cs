    ...
    class FallingTile
    {
        ...
        public Rectangle BoundingRectangle
        {
            get
            {
                ...
                return new Rectangle(left, top - texture.Height/2, texture.Width, texture.Height);
            }
        }
        ...
        /// </summary>
        public FallingTile(Level level, Vector2 position, Vector2 tilePosition)
        {
            this.level = level;
        ...
        {
            texture = Level.Content.Load<Texture2D>("Tiles/VallendBlok");
